...
let sampleNameCategoryPairs: [(name: String, category: SampleCategoryChip)] = [
    ("Most Rewatchable Comedies", SampleCategoryChip(id: "entertainment-entertainment", name: "Entertainment", icon: "star.fill", synonyms: "fun, leisure, media, amusement, recreation")),
    ("Personal Favourite Underdog Finals", SampleCategoryChip(id: "sports-sports", name: "Sports", icon: "soccerball", synonyms: "sports, games, athletics, competition, events")),
    ("Most Iconic Music Videos", SampleCategoryChip(id: "music-music", name: "Music", icon: "music.note", synonyms: "songs, tracks, singles, compositions, tunes")),
    ("Most Majestic Fauna", SampleCategoryChip(id: "animals-animals", name: "Animals", icon: "pawprint.fill", synonyms: "animals, wildlife, creatures, fauna, beasts")),
    ("My Favourite Comfort Food Dishes", SampleCategoryChip(id: "food-food", name: "Food", icon: "fork.knife", synonyms: "food, cuisine, fare, dishes, meals")),
    ("Best Favourite Go-To Iced Drinks", SampleCategoryChip(id: "drinks-drinks", name: "Drinks", icon: "waterbottle.fill", synonyms: "drinks, beverages, refreshments, quenchers, libations")),
    ("Top 10 Philosophy Reads", SampleCategoryChip(id: "humanities-humanities", name: "Humanities", icon: "building.columns.fill", synonyms: "culture, history, society, philosophy, arts")),
    ("My Favourite Native Shrubs", SampleCategoryChip(id: "plants-plants", name: "Plants", icon: "leaf.fill", synonyms: "plants, flora, greenery, vegetation, botany")),
    ("My Favourite Open Datasets & APIs", SampleCategoryChip(id: "stem-stem", name: "STEM", icon: "atom", synonyms: "science, technology, engineering, mathematics")),
    ("Top 10 Visionaries", SampleCategoryChip(id: "people-people", name: "People", icon: "figure.arms.open", synonyms: "individuals, persons, humans, figures, populace")),
    ("Most Efficient Way to Travel", SampleCategoryChip(id: "vehicles-vehicles", name: "Vehicles", icon: "car.side.fill", synonyms: "cars, transport, automobiles, vehicles, machines")),
    ("Top 10 Brand Revivals", SampleCategoryChip(id: "brands-brands", name: "Brands", icon: "shield.righthalf.filled", synonyms: "labels, companies, trademarks, logos, manufacturers")),
    ("My Favourite Party Games", SampleCategoryChip(id: "misc-misc", name: "Misc", icon: "dice.fill", synonyms: "other, random, idk")),
    ("My Top Timber Pavilions", SampleCategoryChip(id: "other-other", name: "Other", icon: "questionmark", synonyms: "other, I don't know, nothing, default")),
    ("Most Controversial Celebrities", SampleCategoryChip(id: "entertainment-celebrities", name: "Celebrities", icon: "star.fill", synonyms: "celebrities, stars, icons, public figures, VIPs")),
    ("Top 20 Films of the 1990s", SampleCategoryChip(id: "entertainment-movies", name: "Movies", icon: "movieclapper", synonyms: "movies, films, cinema, flicks, motion pictures")),
    ("The Sitcoms I'm Currently Binging", SampleCategoryChip(id: "entertainment-tvshows", name: "TV Shows", icon: "tv.fill", synonyms: "TV shows, series, programs, broadcasts, sitcoms")),
    ("Top 10 James Patterson Novels", SampleCategoryChip(id: "entertainment-books", name: "Books", icon: "books.vertical.fill", synonyms: "books, novels, literature, texts, publications")),
    ("Top 5 Streaming Services with the Best Films", SampleCategoryChip(id: "entertainment-streamingservices", name: "Streaming Services", icon: "play.rectangle.fill", synonyms: "streaming, OTT, platforms, providers, video services")),
    ("My Most Used Social Media Platforms", SampleCategoryChip(id: "entertainment-socialmedia", name: "Social Media", icon: "message.fill", synonyms: "social media, networks, platforms, online communities, feeds")),
    ("Top 10 Releases Last Year", SampleCategoryChip(id: "entertainment-gaming", name: "Gaming", icon: "gamecontroller.fill", synonyms: "gaming, video games, esports, gameplay, consoles")),
    ("Absolute Must Play Board Games", SampleCategoryChip(id: "entertainment-boardgames", name: "Board Games", icon: "dice.fill", synonyms: "board games, tabletop, strategy, dice games, classics")),
    ("Top 10 Card Games Everyone Should Know", SampleCategoryChip(id: "entertainment-cardgames", name: "Card Games", icon: "suit.club.fill", synonyms: "card games, playing cards, poker, blackjack, bridge")),
    ("Top 50 Memes Since 2008", SampleCategoryChip(id: "entertainment-memes", name: "Memes", icon: "camera.fill", synonyms: "memes, internet humor, viral images, jokes, online memes")),
    ("Top 10 Oil Paintings of All Time", SampleCategoryChip(id: "entertainment-artdesign", name: "Art & Design", icon: "paintbrush.pointed.fill", synonyms: "art, design, creativity, graphics, illustration")),
    ("Best Quotes From Man's Search for Meaning", SampleCategoryChip(id: "entertainment-quotes", name: "Quotes", icon: "quote.opening", synonyms: "quotes, sayings, aphorisms, proverbs, citations")),
    ("Top 30 Olympians of All Time", SampleCategoryChip(id: "sports-athletes", name: "Athletes", icon: "figure.run", synonyms: "athletes, players, competitors, sportspeople, stars")),
    ("Most Competitive Leagues", SampleCategoryChip(id: "sports-leaguestournaments", name: "Leagues & Tournaments", icon: "trophy.fill", synonyms: "leagues, tournaments, competitions, championships, cups")),
    ("Most Valuable Sporting Clubs", SampleCategoryChip(id: "sports-clubsteams", name: "Clubs/Teams", icon: "shield.lefthalf.filled", synonyms: "clubs, teams, organizations, franchises, squads")),
    ("Highest Capacity Stadiums", SampleCategoryChip(id: "sports-stadiums", name: "Stadiums", icon: "sportscourt.fill", synonyms: "stadiums, venues, arenas, fields, locations")),
    ("Most Iconic Coaches and Managers", SampleCategoryChip(id: "sports-coachesmanagers", name: "Coaches & Managers", icon: "megaphone.fill", synonyms: "coaches, managers, trainers, mentors, instructors")),
    ("Most Iconic Commentary of All Time", SampleCategoryChip(id: "sports-commentators", name: "Commentators", icon: "headset", synonyms: "commentators, announcers, broadcasters, analysts, hosts")),
    ("Top 15 Most Intense Sporting Rivalries", SampleCategoryChip(id: "sports-rivalries", name: "Rivalries", icon: "oar.2.crossed", synonyms: "rivalries, feuds, matchups, competitions, duels")),
    ("Favourite Club Mascots", SampleCategoryChip(id: "sports-mascots", name: "Mascots", icon: "figure.dance", synonyms: "mascots, symbols, emblems, characters, icons")),
    ("Top 5 Most Underused Gym Equipment", SampleCategoryChip(id: "sports-gym", name: "Gym", icon: "dumbbell.fill", synonyms: "gym, fitness, training, workouts, exercise")),
    ("Top 10 Most Influential Artists of the 2010s", SampleCategoryChip(id: "music-artists", name: "Artists", icon: "music.microphone", synonyms: "artists, bands, musicians, performers, acts")),
    ("My Favourite Tracks for Night Drives", SampleCategoryChip(id: "music-songs", name: "Songs", icon: "music.quarternote.3", synonyms: "songs, tracks, singles, hits, tunes")),
    ("Albums That Defined My Childhood", SampleCategoryChip(id: "music-albums", name: "Albums", icon: "record.circle", synonyms: "albums, records, LPs, collections, discs")),
    ("My Top 5 Woodwind Instruments", SampleCategoryChip(id: "music-instruments", name: "Instruments", icon: "guitars.fill", synonyms: "instruments, gear, equipment, devices, tools")),
    ("Most Stacked Lineups of All Time", SampleCategoryChip(id: "music-festivals", name: "Festivals", icon: "hifispeaker.2.fill", synonyms: "festivals, concerts, events, carnivals, gatherings")),
    ("Ranking the Best Artists Under Cactus Jack", SampleCategoryChip(id: "music-recordlabels", name: "Record Labels", icon: "tag.fill", synonyms: "labels, studios, companies, distributors, imprints")),
    ("Most Influential Music Genres of the 21st Century", SampleCategoryChip(id: "music-genres", name: "Genres", icon: "music.quarternote.3", synonyms: "genres, styles, categories, types, classifications")),
    ("Top 15 Mammal Orders by Species Diversity", SampleCategoryChip(id: "animals-mammals", name: "Mammals", icon: "hare.fill", synonyms: "mammals, beasts, animals, vertebrates, warm-blooded")),
    ("My Favourite Wild Birds", SampleCategoryChip(id: "animals-birds", name: "Birds", icon: "bird.fill", synonyms: "birds, avians, fowl, feathered, winged")),
    ("Top 10 Reptiles to Keep as Pets", SampleCategoryChip(id: "animals-reptiles", name: "Reptiles", icon: "lizard.fill", synonyms: "reptiles, scaly, cold-blooded, lizards, snakes")),
    ("Top 20 Reef Fish to Spot While Snorkeling", SampleCategoryChip(id: "animals-fish", name: "Fish", icon: "fish.fill", synonyms: "fish, aquatic, marine life, sea creatures, species")),
    ("My Favourite Species of Frog", SampleCategoryChip(id: "animals-amphibians", name: "Amphibians", icon: "drop.fill", synonyms: "amphibians, frogs, toads, salamanders, newts")),
    ("My Favourite Pollinating Bugs", SampleCategoryChip(id: "animals-invertebrates", name: "Invertebrates", icon: "ant.fill", synonyms: "invertebrates, spineless, inverts, non-vertebrates, soft-bodied")),
    ("My Favourite Seasonal Fruits", SampleCategoryChip(id: "food-fruits", name: "Fruits", icon: "applelogo", synonyms: "fruits, produce, fresh fruit, orchard, citrus")),
    ("Most Underrated Vegetables for Roasting", SampleCategoryChip(id: "food-vegetables", name: "Vegetables", icon: "carrot.fill", synonyms: "vegetables, veg, greens, produce, veggies")),
    ("Best High-Protein Fast Food Items", SampleCategoryChip(id: "food-fastfood", name: "Fast Food", icon: "takeoutbag.and.cup.and.straw.fill", synonyms: "fast food, takeaway, takeout, quick-service, QSR")),
    ("Absolute Must Snacks While Losing Weight", SampleCategoryChip(id: "food-snacks", name: "Snacks", icon: "popcorn.fill", synonyms: "snacks, munchies, nibbles, treats, bites")),
    ("S-Tier Chocolate Bars", SampleCategoryChip(id: "food-chocolate", name: "Chocolate", icon: "square.grid.3x3.fill", synonyms: "chocolate, cocoa, chocolate bars, confectionery, sweets")),
    ("Most Iconic Pasta Shapes", SampleCategoryChip(id: "food-pasta", name: "Pasta", icon: "scribble", synonyms: "pasta, noodles, spaghetti, macaroni, penne")),
    ("Definitive Ranking of Dairy Staples", SampleCategoryChip(id: "food-dairy", name: "Dairy", icon: "drop.circle.fill", synonyms: "dairy, milk products, dairy goods, dairy foods, lactose")),
    ("My Favourite Soft-Scramble Techniques", SampleCategoryChip(id: "food-eggs", name: "Eggs", icon: "oval.portrait.fill", synonyms: "eggs, egg products, free-range, cage-free, omelettes")),
    ("Top 20 Breakfast Cereals by Crunch", SampleCategoryChip(id: "food-breakfastcereals", name: "Breakfast Cereals", icon: "sunrise.fill", synonyms: "cereals, breakfast, muesli, granola, cornflakes")),
    ("Peak Ice Cream Flavours", SampleCategoryChip(id: "food-icecream", name: "Ice Cream", icon: "snowflake", synonyms: "ice cream, gelato, sorbet, soft serve, frozen dessert")),
    ("Top 10 NYC Deli Classics", SampleCategoryChip(id: "food-sandwiches", name: "Sandwiches", icon: "square.split.diagonal.fill", synonyms: "sandwiches, subs, rolls, wraps, toasties")),
    ("My Favourite Crumbles of All Time", SampleCategoryChip(id: "food-desserts", name: "Desserts", icon: "birthday.cake.fill", synonyms: "desserts, sweets, puddings, pastries, confectionery")),
    ("Top 15 Street Foods Worldwide", SampleCategoryChip(id: "food-cuisines", name: "Cuisines", icon: "globe.europe.africa.fill", synonyms: "cuisines, food styles, regional, international, ethnic foods")),
    ("My Favourite Citrus Sodas", SampleCategoryChip(id: "drinks-soda", name: "Soda", icon: "bubbles.and.sparkles.fill", synonyms: "soft drinks, sodas, pop, fizzy drinks, carbonated beverages")),
    ("Top 15 Single Malts to Savour", SampleCategoryChip(id: "drinks-alcohol", name: "Alcohol", icon: "wineglass.fill", synonyms: "alcohol, spirits, booze, liquors, alcoholic beverages")),
    ("My Favourite Light Roast Pour-Overs", SampleCategoryChip(id: "drinks-coffee", name: "Coffee", icon: "cup.and.saucer.fill", synonyms: "coffee, espresso, lattes, cappuccinos, brews")),
    ("My Favourite Breakfast Blends", SampleCategoryChip(id: "drinks-tea", name: "Tea", icon: "leaf.fill", synonyms: "tea, herbal, cup, drink, relax")),
    ("Most Underrated Mountain Ranges", SampleCategoryChip(id: "humanities-geography", name: "Geography", icon: "globe.europe.africa.fill", synonyms: "geography, maps, regions, locations, places")),
    ("Top 25 Turning Points in History", SampleCategoryChip(id: "humanities-history", name: "History", icon: "building.columns.fill", synonyms: "history, past, heritage, chronology, record")),
    ("Most Valuable Companies in 2025", SampleCategoryChip(id: "humanities-business", name: "Business", icon: "case.fill", synonyms: "business, important, humaities, boss")),
    ("Top 10 Political Debates Since 2000", SampleCategoryChip(id: "humanities-politicians", name: "Politicians", icon: "megaphone.fill", synonyms: "politicians, lawmakers, officials, legislators, statespeople")),
    ("My Favourire Fragrant Garden Blooms", SampleCategoryChip(id: "plants-flowers", name: "Flowers", icon: "camera.macro", synonyms: "flowers, blooms, blossoms, petals, flora")),
    ("Top 10 Urban Shade Trees", SampleCategoryChip(id: "plants-trees", name: "Trees", icon: "tree.fill", synonyms: "trees, timber, woods, forestry, saplings")),
    ("Top 5 Prime Numbers", SampleCategoryChip(id: "stem-numbers", name: "Numbers", icon: "123.rectangle.fill", synonyms: "numbers, numerals, digits, figures, integers")),
    ("Top 15 Breakthroughs This Century", SampleCategoryChip(id: "stem-science", name: "Science", icon: "testtube.2", synonyms: "science, research, experiments, laboratory, inquiry")),
    ("My Favourite Pair of Headphones", SampleCategoryChip(id: "stem-technology", name: "Technology", icon: "cpu", synonyms: "technology, tech, computing, innovation, gadgets")),
    ("Top 20 Theorems To Know", SampleCategoryChip(id: "stem-mathematics", name: "Mathematics", icon: "x.squareroot", synonyms: "mathematics, math, arithmetic, calculus, algebra")),
    ("Most Useless Programming Languages", SampleCategoryChip(id: "stem-programming", name: "Programming", icon: "chevron.left.forwardslash.chevron.right", synonyms: "programming, coding, software, development, scripts")),
    ("All Letters Ranked for No Apparent Reason", SampleCategoryChip(id: "stem-alphabet", name: "Alphabet", icon: "textformat", synonyms: "alphabet, letters, ABC, characters, glyphs")),
    ("My Favourite Clock Dials in Roman", SampleCategoryChip(id: "stem-romannumerals", name: "Roman Numerals", icon: "multiply", synonyms: "Roman numerals, Latin numerals, classical numbers, I‑V‑X, notation")),
    ("Most Controversial Celebrities", SampleCategoryChip(id: "people-celebrities", name: "Celebrities", icon: "star.fill", synonyms: "celebrities, stars, icons, public figures, VIPs")),
    ("My Childhood Favourite YouTube Creators", SampleCategoryChip(id: "people-contentcreators", name: "Content Creators", icon: "play.square.fill", synonyms: "creators, influencers, producers, streamers, bloggers")),
    ("Top 10 Method Performers", SampleCategoryChip(id: "people-actors", name: "Actors", icon: "movieclapper.fill", synonyms: "actors, performers, thespians, cast, artistes")),
    ("My Favourite Short Story Masters", SampleCategoryChip(id: "people-authors", name: "Authors", icon: "book.fill", synonyms: "authors, writers, novelists, scribes, wordsmiths")),
    ("My Personal Top 10 Live Performances", SampleCategoryChip(id: "people-musicians", name: "Musicians", icon: "music.mic", synonyms: "musicians, artists, instrumentalists, singers, bands")),
    ("Global Leaders Approval Rating", SampleCategoryChip(id: "people-worldleaders", name: "World Leaders", icon: "person.bust.fill", synonyms: "leaders, presidents, prime ministers, officials, heads of state")),
    ("Top 10 Runway Icons Right Now", SampleCategoryChip(id: "people-models", name: "Models", icon: "camera.fill", synonyms: "models, mannequins, supermodels, figures, replicas")),
    ("Top 10 Stand-Up Specials", SampleCategoryChip(id: "people-comedians", name: "Comedians", icon: "theatermasks.fill", synonyms: "comedians, comics, humorists, jokesters, stand-ups")),
    ("Top 10 Startup Founders", SampleCategoryChip(id: "people-entrepreneurs", name: "Entrepreneurs", icon: "banknote.fill", synonyms: "entrepreneurs, founders, business owners, innovators, startups")),
    ("My Favourite Chef's Signatures", SampleCategoryChip(id: "people-chefs", name: "Chefs", icon: "frying.pan.fill", synonyms: "chefs, cooks, culinarians, sous-chefs, gastronome")),
    ("Most Impactful Voices for Abortion Rights", SampleCategoryChip(id: "people-activists", name: "Activists", icon: "megaphone.fill", synonyms: "activists, advocates, campaigners, protesters, reformers")),
    ("Favourite Cars I've Personally Driven", SampleCategoryChip(id: "vehicles-cars", name: "Cars", icon: "car.fill", synonyms: "cars, automobiles, autos, sedans, coupes")),
    ("Best Offshore Boat Under 80K", SampleCategoryChip(id: "vehicles-boats", name: "Boats", icon: "sailboat.fill", synonyms: "boats, vessels, watercraft, ships, craft")),
    ("Most Iconic Fighter Jets", SampleCategoryChip(id: "vehicles-planes", name: "Planes", icon: "airplane", synonyms: "planes, aircraft, airplanes, jets, aeroplanes")),
    ("My Favourite Scenic Rail Routes", SampleCategoryChip(id: "vehicles-trains", name: "Trains", icon: "tram.fill", synonyms: "trains, rail, locomotives, carriages, railways")),
    ("Top 10 Ballon d'Or Contendors for This Year", SampleCategoryChip(id: "sports-athletes-footballers", name: "Footballers", icon: "figure.soccer", synonyms: "footballers, soccer players, strikers, midfielders, goalkeepers")),
    ("My Favourite Clutch Shooters", SampleCategoryChip(id: "sports-athletes-basketballers", name: "Basketballers", icon: "figure.basketball", synonyms: "basketballers, basketball players, hoopers, guards, forwards")),
    ("Most Reliable All-Rounders", SampleCategoryChip(id: "sports-athletes-cricketers", name: "Cricketers", icon: "figure.cricket", synonyms: "cricketers, batsmen, bowlers, all-rounders, wicketkeepers")),
    ("Most Clutch Key Forwards This Season", SampleCategoryChip(id: "sports-athletes-australianfootballers", name: "Australian Footballers", icon: "figure.australian.football", synonyms: "AFL players, footy players, midfielders, forwards, defenders")),
    ("Most Dominant Clay-Court Players", SampleCategoryChip(id: "sports-athletes-tennisplayers", name: "Tennis Players", icon: "figure.tennis", synonyms: "tennis players, pros, servers, baseliners, doubles specialists")),
    ("Top 10 Dual-Threat QBs", SampleCategoryChip(id: "sports-athletes-americanfootballers", name: "American Footballers", icon: "figure.american.football", synonyms: "football players, gridiron players, quarterbacks, receivers, linebackers")),
    ("Fastest Qualifying Laps in F1", SampleCategoryChip(id: "sports-athletes-motorsportdrivers", name: "Motorsport Drivers", icon: "steeringwheel", synonyms: "drivers, racers, racecar drivers, pilots, competitors")),
    ("Most Feared Enforcers", SampleCategoryChip(id: "sports-athletes-hockeyplayers", name: "Hockey Players", icon: "figure.hockey", synonyms: "hockey players, skaters, forwards, defensemen, goalies")),
    ("Most Reliable Pitchers", SampleCategoryChip(id: "sports-athletes-baseballers", name: "Baseballers", icon: "figure.baseball", synonyms: "baseballers, baseball players, ballplayers, hitters, pitchers")),
    ("Top 5 Line-Break Merchants", SampleCategoryChip(id: "sports-athletes-rugbyplayers", name: "Rugby Players", icon: "figure.rugby", synonyms: "rugby players, union players, league players, forwards, backs")),
    ("My Favourite Major Performances Since 2020", SampleCategoryChip(id: "sports-athletes-golfers", name: "Golfers", icon: "figure.golf", synonyms: "golfers, players, pros, putters, drivers")),
    ("Most Devastating KO Artists", SampleCategoryChip(id: "sports-athletes-boxers", name: "Boxers", icon: "figure.boxing", synonyms: "boxers, pugilists, fighters, contenders, champions")),
    ("Most Elite Grapplers in the UFC", SampleCategoryChip(id: "sports-athletes-mmafighters", name: "MMA Fighters", icon: "figure.martial.arts", synonyms: "mixed martial artists, MMA fighters, cage fighters, strikers, grapplers")),
    ("Top 5 Youth Leagues", SampleCategoryChip(id: "sports-leaguestournaments-footballleagues", name: "Football Leagues", icon: "checkerboard.shield", synonyms: "leagues, competitions, divisions, associations, tables")),
    ("Least Wanted Trophy's in England", SampleCategoryChip(id: "sports-leaguestournaments-footballcups", name: "Football Cups", icon: "trophy.fill", synonyms: "cups, knockouts, tournaments, finals, silverware")),
    ("Best Leagues for Development", SampleCategoryChip(id: "sports-leaguestournaments-basketballleagues", name: "Basketball Leagues", icon: "checkerboard.shield", synonyms: "leagues, conferences, divisions, associations, seasons")),
    ("Top 5 T20 Leagues in the World", SampleCategoryChip(id: "sports-leaguestournaments-cricketleagues", name: "Cricket Leagues", icon: "checkerboard.shield", synonyms: "leagues, tournaments, T20, franchises, domestic")),
    ("Ranking All the Feeder Leagues to the AFL", SampleCategoryChip(id: "sports-leaguestournaments-australianfootballleagues", name: "Australian Football Leagues", icon: "checkerboard.shield", synonyms: "leagues, AFL, state leagues, comps, seasons")),
    ("Ranking All Grand Slams from Experience", SampleCategoryChip(id: "sports-leaguestournaments-tennistournaments", name: "Tennis Tournaments", icon: "checkerboard.shield", synonyms: "tournaments, slams, tours, ATP/WTA, events")),
    ("My Favourite College Conferences", SampleCategoryChip(id: "sports-leaguestournaments-americanfootballleagues", name: "American Football Leagues", icon: "checkerboard.shield", synonyms: "leagues, NFL, conferences, divisions, seasons")),
    ("This Season's F1 Circuits Ranked", SampleCategoryChip(id: "sports-leaguestournaments-motorsporttracks", name: "Motorsport Tracks", icon: "flag.checkered.2.crossed", synonyms: "circuits, tracks, speedways, raceways, venues")),
    ("Next Season's EPL Table Prediction", SampleCategoryChip(id: "sports-clubsteams-footballclubs", name: "Football Clubs", icon: "shield.lefthalf.filled", synonyms: "clubs, teams, sides, squads, franchises")),
    ("Next Season's NBA Table Prediction", SampleCategoryChip(id: "sports-clubsteams-basketballteams", name: "Basketball Teams", icon: "shield.lefthalf.filled", synonyms: "teams, clubs, franchises, rosters, squads")),
    ("Big 3 Predictions for Next Year", SampleCategoryChip(id: "sports-clubsteams-cricketteams", name: "Cricket Teams", icon: "shield.lefthalf.filled", synonyms: "teams, XI, franchises, squads, sides")),
    ("Next Season's AFL Ladder Prediction", SampleCategoryChip(id: "sports-clubsteams-australianfootballclubs", name: "Australian Football Clubs", icon: "shield.lefthalf.filled", synonyms: "clubs, teams, footy clubs, sides, outfits")),
    ("NFL Playoff Predictions", SampleCategoryChip(id: "sports-clubsteams-americanfootballclubs", name: "American Football Clubs", icon: "shield.lefthalf.filled", synonyms: "teams, franchises, rosters, squads, clubs")),
    ("Most Dominant Constructors in MotoGP", SampleCategoryChip(id: "sports-clubsteams-motorsportconstructors", name: "Motorsport Constructors", icon: "wrench.and.screwdriver.fill", synonyms: "constructors, teams, manufacturers, works teams, factories")),
    ("Most Underrated Machines for Chest & Triceps", SampleCategoryChip(id: "sports-gym-gymmachines", name: "Gym Machines", icon: "figure.hand.cycling", synonyms: "exercises, workouts, routines, movements, drills")),
    ("My Top 5 Push-Pull Supersets", SampleCategoryChip(id: "sports-gym-gymexercises", name: "Gym Exercises", icon: "figure.indoor.cycle", synonyms: "machines, equipment, apparatus, gear, devices")),
    ("Top 20 Dog Breeds Based Off Adorableness", SampleCategoryChip(id: "animals-mammals-dogs", name: "Dogs", icon: "dog.fill", synonyms: "dogs, canines, hounds, pups, pooches")),
    ("Best Hypoallergenic Domestic Cat Breeds", SampleCategoryChip(id: "animals-mammals-cats", name: "Cats", icon: "cat.fill", synonyms: "cats, felines, kitties, toms, moggies")),
    ("Most Elusive Carnivores", SampleCategoryChip(id: "animals-mammals-carnivores", name: "Carnivores", icon: "fork.knife", synonyms: "carnivores, meat-eaters, predators, hunters, flesh-eaters")),
    ("Most Social Primate Troops", SampleCategoryChip(id: "animals-mammals-primates", name: "Primates", icon: "brain.head.profile", synonyms: "primates, apes, monkeys, hominoids, simians")),
    ("Top 7 Rodents to Keep as Pets", SampleCategoryChip(id: "animals-mammals-rodents", name: "Rodents", icon: "pawprint.circle", synonyms: "rodents, gnawers, murids, rats, mice")),
    ("Ranking Rabbits Based on Coat Colour and Feel", SampleCategoryChip(id: "animals-mammals-rabbitshares", name: "Rabbits & Hares", icon: "hare.fill", synonyms: "rabbits, hares, lagomorphs, bunnies, coneys")),
    ("Top 10 Deadliest Marine Mammals", SampleCategoryChip(id: "animals-mammals-marinemammals", name: "Marine Mammals", icon: "water.waves", synonyms: "marine mammals, cetaceans, pinnipeds, sea mammals, oceanic mammals")),
    ("All Marsupials in Australia Ranked", SampleCategoryChip(id: "animals-mammals-marsupials", name: "Marsupials", icon: "pawprint.circle.fill", synonyms: "marsupials, pouched mammals, macropods, kangaroos, possums")),
    ("Most Majestic Deer Species", SampleCategoryChip(id: "animals-mammals-hoofedmammals", name: "Hoofed Mammals", icon: "shoeprints.fill", synonyms: "hoofed mammals, ungulates, hoofstock, grazers, ruminants")),
    ("Most Unique Monotreme Traits", SampleCategoryChip(id: "animals-mammals-monotremes", name: "Monotremes", icon: "oval.portrait.fill", synonyms: "monotremes, egg-laying mammals, platypuses, echidnas, prototherians")),
    ("My Favourite Melodic Warblers", SampleCategoryChip(id: "animals-birds-songbirds", name: "Songbirds", icon: "music.note", synonyms: "songbirds, passerines, perching birds, oscines, warblers")),
    ("Favourite Owl Sounds", SampleCategoryChip(id: "animals-birds-birdsofprey", name: "Birds of Prey", icon: "binoculars.fill", synonyms: "raptors, birds of prey, raptorial birds, eagles, hawks")),
    ("Ranking Aussie Parakeets", SampleCategoryChip(id: "animals-birds-parrots", name: "Parrots", icon: "leaf.fill", synonyms: "parrots, psittacines, parakeets, macaws, cockatoos")),
    ("Most Elegant Ground-Doves", SampleCategoryChip(id: "animals-birds-pidgeonsdoves", name: "Pidgeons & Doves", icon: "envelope.fill", synonyms: "pigeons, doves, columbids, rock doves, squabs")),
    ("Top 10 Pelagic Birds to Watch", SampleCategoryChip(id: "animals-birds-seabirds", name: "Seabirds", icon: "water.waves", synonyms: "seabirds, marine birds, pelagic birds, oceanic birds, coastal birds")),
    ("Top 10 Ratites in the Wild", SampleCategoryChip(id: "animals-birds-flightlessbirds", name: "Flightless Birds", icon: "figure.walk", synonyms: "flightless birds, ratites, ground birds, penguins, emus")),
    ("My Favourite Desert Lizards", SampleCategoryChip(id: "animals-reptiles-lizards", name: "Lizards", icon: "lizard.fill", synonyms: "lizards, saurians, geckos, skinks, iguanas")),
    ("Most Venemous Snakes I Have Owned", SampleCategoryChip(id: "animals-reptiles-snakes", name: "Snakes", icon: "scribble.variable", synonyms: "snakes, serpents, ophidians, boas, vipers")),
    ("My Favourite Species of Terrapin", SampleCategoryChip(id: "animals-reptiles-turtlestortoises", name: "Turtles & Tortoises", icon: "tortoise.fill", synonyms: "turtles, tortoises, chelonians, terrapins, shelled reptiles")),
    ("Crocs & Gators I Don't Want To Face", SampleCategoryChip(id: "animals-reptiles-crocodilesalligators", name: "Crocodiles & Alligators", icon: "lizard", synonyms: "crocodilians, crocs, gators, caimans, gharials")),
    ("My Favourite Indo-Pacific Reef Fish Species", SampleCategoryChip(id: "animals-fish-reeffish", name: "Reef Fish", icon: "fish.fill", synonyms: "reef fish, coral fish, tropical fish, reef dwellers, reef species")),
    ("Most Misunderstood Shark Species", SampleCategoryChip(id: "animals-fish-sharks", name: "Sharks", icon: "exclamationmark.triangle.fill", synonyms: "sharks, elasmobranchs, selachimorphs, apex predators, cartilaginous fish")),
    ("Most Graceful Blue-Spotted Rays", SampleCategoryChip(id: "animals-fish-raysskates", name: "Rays & Skates", icon: "line.diagonal.arrow", synonyms: "rays, skates, batoids, stingrays, mantas")),
    ("Most Breath-Taking Whale Songs & Whistles", SampleCategoryChip(id: "animals-fish-whales", name: "Whales", icon: "wave.3.forward", synonyms: "whales, cetaceans, baleen whales, toothed whales, leviathans")),
    ("My Favourite Tree Frogs", SampleCategoryChip(id: "animals-amphibians-frogstoads", name: "Frogs & Toads", icon: "camera.macro", synonyms: "frogs, toads, anurans, hylids, bufonids")),
    ("My Favourite Newts and Efts", SampleCategoryChip(id: "animals-amphibians-salamanders", name: "Salamanders", icon: "flame.fill", synonyms: "salamanders, newts, caudates, urodelans, amphibians")),
    ("Most Beautiful Butterfly Species", SampleCategoryChip(id: "animals-invertebrates-insects", name: "Insects", icon: "ant.fill", synonyms: "insects, hexapods, bugs, beetles, arthropods")),
    ("Biggest & Scariest Tarantulas", SampleCategoryChip(id: "animals-invertebrates-arachnids", name: "Arachnids", icon: "staroflife.fill", synonyms: "arachnids, spiders, scorpions, mites, ticks")),
    ("My Favourite Crab TikToks", SampleCategoryChip(id: "animals-invertebrates-crustaceans", name: "Crustaceans", icon: "fish.fill", synonyms: "crustaceans, crabs, shrimp, lobsters, krill")),
    ("Most Chill Millipede Species", SampleCategoryChip(id: "animals-invertebrates-myriapods", name: "Myriapods", icon: "line.3.horizontal", synonyms: "myriapods, centipedes, millipedes, arthropods, polydesmids")),
    ("Most Beautiful Mollusks", SampleCategoryChip(id: "animals-invertebrates-mollusks", name: "Mollusks", icon: "moon.fill", synonyms: "mollusks, gastropods, bivalves, cephalopods, shellfish")),
    ("My Favourite Bait Worms", SampleCategoryChip(id: "animals-invertebrates-worms", name: "Worms", icon: "scribble", synonyms: "worms, annelids, earthworms, nematodes, flatworms")),
    ("Ranking My Favourite Drive-Thrus", SampleCategoryChip(id: "food-fastfood-fastfoodchains", name: "Fast Food Chains", icon: "storefront.fill", synonyms: "chains, QSR brands, franchises, outlets, restaurants")),
    ("Ranking Italian Regional Pizza Styles", SampleCategoryChip(id: "food-fastfood-pizza", name: "Pizza", icon: "cone.fill", synonyms: "pizza, pies, slices, pizzeria, deep dish")),
    ("My Go-To Burgers on Friday Night", SampleCategoryChip(id: "food-fastfood-burgers", name: "Burgers", icon: "flame.fill", synonyms: "burgers, hamburgers, cheeseburgers, patties, sliders")),
    ("Hands-Down Best Fried Chicken in the USA", SampleCategoryChip(id: "food-fastfood-friedchicken", name: "Fried Chicken", icon: "frying.pan.fill", synonyms: "fried chicken, tenders, wings, drumsticks, crispy chicken")),
    ("Best Takeaway Styles of Fries & Hot Chips", SampleCategoryChip(id: "food-fastfood-fries", name: "Fries", icon: "takeoutbag.and.cup.and.straw.fill", synonyms: "fries, chips, hot chips, french fries, wedges")),
    ("Top 10 Milks for Coffee", SampleCategoryChip(id: "food-dairy-milk", name: "Milk", icon: "drop.fill", synonyms: "milk, whole milk, skim, dairy milk, lactose")),
    ("My Favourite Cheese Platters Cheeses", SampleCategoryChip(id: "food-dairy-cheese", name: "Cheese", icon: "triangle.fill", synonyms: "cheese, cheddar, mozzarella, gouda, parmesan")),
    ("My Go-To Morning Yogurts", SampleCategoryChip(id: "food-dairy-yogurt", name: "Yogurt", icon: "cup.and.saucer.fill", synonyms: "yogurt, yoghurt, cultured milk, greek yogurt, dairy snack")),
    ("My Top 10 Comfort Liquor", SampleCategoryChip(id: "drinks-alcohol-liquorsliqueurs", name: "Liquors & Liqueurs", icon: "flame.fill", synonyms: "liquors, liqueurs, spirits, cordials, aperitifs")),
    ("Top 10 Classic Cocktails", SampleCategoryChip(id: "drinks-alcohol-cocktails", name: "Cocktails", icon: "beach.umbrella.fill", synonyms: "cocktails, mixed drinks, libations, concoctions, beverages")),
    ("My Go-To Party Premixes", SampleCategoryChip(id: "drinks-alcohol-premixes", name: "Premixes", icon: "shuffle", synonyms: "premixes, ready-made, pre-batched, mixed drinks, beverages")),
    ("Top 20 Countries for Solo Travel", SampleCategoryChip(id: "humanities-geography-countries", name: "Countries", icon: "globe.europe.africa.fill", synonyms: "countries, nations, states, republics, territories")),
    ("Each Continent Ranked By Size", SampleCategoryChip(id: "humanities-geography-continents", name: "Continents", icon: "globe", synonyms: "continents, landmasses, regions, hemispheres, areas")),
    ("My Favourite World Heritage Sites", SampleCategoryChip(id: "humanities-geography-landmarks", name: "Landmarks", icon: "building.columns.fill", synonyms: "landmarks, monuments, sites, attractions, icons")),
    ("My Favourite Nightlife Capitals", SampleCategoryChip(id: "humanities-geography-cities", name: "Cities", icon: "building.2.fill", synonyms: "cities, metropolises, towns, municipalities, urban areas")),
    ("Each Solar System Planet Ranked For No Reason", SampleCategoryChip(id: "stem-science-planets", name: "Planets", icon: "circle.hexagonpath.fill", synonyms: "planets, worlds, solar system, orbits, celestial bodies")),
    ("My Favourite Noble Gases", SampleCategoryChip(id: "stem-science-elements", name: "Elements", icon: "atom", synonyms: "elements, periodic table, chemical elements, atoms, substances")),
]
